...
then
 ...
 docker run --network host --privileged --mount source=kamailio-rtpengine_kamailio,target=/etc/kamailio --mount source=kamailio-rtpengine_db,target=/var/lib/mysql--name kamailio -itd kamailio-rtpengine-kamailio
else
